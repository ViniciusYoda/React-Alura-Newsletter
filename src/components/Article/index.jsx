const Article = ({ title, text, tags, image, alt }) => {
   return(
      <div className="p-5 bg-gray-200 dark:bg-dark-200 sm:rounded-xl sm:shadow-lg flex gap-2 flex-col itens-center">
         <h3 className="text-xl text-alra-200 dark:text-gray-200 font-bold">{title}</h3>
